...
class FrictionDetector(contactListener):
    ...
    def _contact(self, contact, begin):
        ...
        # other function can check this variable to know if the car is still on the road and still moving
    ...
    def _step(self, action):
        ...
        if action is not None: # First step without action, called from reset()
            ...
            if self.contactListener_keepref.lastTouchRoadTime is not None and \
                    time.time() - self.contactListener_keepref.lastTouchRoadTime > 1.0:
                step_reward = -100
                done = True
    ...
    while True:
        ...
        while True:
            ...
            if steps % 200 == 0 or done:
                ...
                plt.imsave('%d.png'%(steps),s,format='png')
